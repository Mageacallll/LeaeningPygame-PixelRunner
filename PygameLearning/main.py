...
def obstacle_movement(obstacle_list):
    if obstacle_list:
        ...
        # delete the obstacle if it leaves the screen
...
def player_animation():
    ...
    if player_rect.bottom < 300:  # this means if the player is not on the ground
...
intro_surf = test_font.render('Press space to run', False, (111, 196, 169))
intro_rect = intro_surf.get_rect(center=(400, 340))
...
while True:
    ...
    if game_active:
        ...
        #     player_rect.bottom = 300  # this is the floor
        # player_animation()
